...
namespace Treats.Controllers
{
  ...
  public class SweetsController : Controller
  {
    ...
    public ItemsController(UserManager<ApplicationUser> userManager, TreatsContext db)
    {
    ...
    public async Task<ActionResult> Index()
    {
      ...
      var userItems = _db.Sweets.Where(entry => entry.User.Id == currentUser.Id).ToList();
